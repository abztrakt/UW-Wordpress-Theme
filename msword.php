<?php get_header(); ?>
      ...
      <article id="post-<?php the_ID(); ?>" <?php post_class( 'application-attachment' ); ?>>
          ...
          <iframe class="uw-application-view" style="width:0px;height:0px;" src="<?php echo wp_get_attachment_url(get_the_ID()); ?>"></iframe>

 ...
 */
  function uw_enqueue_default_scripts() {
    ...
    wp_register_script( 'header', get_bloginfo('template_directory') . '/js/header.js', array('jquery'), '1.0' );
    ...
    wp_register_script( 'uwalert','https://washington.edu/static/alert.js', array('jquery') );

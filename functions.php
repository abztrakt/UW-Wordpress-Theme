 ...
 */
  function uw_enqueue_default_styles() {
      ...
      wp_register_style( 'uw-master', get_bloginfo('template_url') . '/style.css', array('bootstrap-responsive'), '3.4.2.4' );
      if ( $is_child_theme)
 ...
 */
  function uw_enqueue_default_scripts() {
    ...
    wp_register_script( 'header', get_bloginfo('template_directory') . '/js/header.js', array('jquery'), '1.2.5' );

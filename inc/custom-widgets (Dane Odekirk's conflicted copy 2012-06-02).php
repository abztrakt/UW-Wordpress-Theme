...
function uw_patch_link_widget( $args ) {
  ...
  $args['category_before'] = '<li id="%id" class="%class">';
...
<?php
    ...
    if (!is_wp_error( $rss ) ) { // Checks that the object is created correctly 
      ...
      $content .= "<a class='more' href='http://depts.washington.edu/newscomm/photos/'> More</a>
                  <a class='http://depts.washington.edu/newscomm/photos/wp-admin/edit.php' href=''>Submit your photos</a>
                  </div>";
